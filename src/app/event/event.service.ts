...
import { InviteResponseDTO } from './model/invite-response';
import { ActivityOverviewDTO, CreateActivityDTO } from './agenda/agenda-component/activity-overview.dto';
import { EventDetailsDTO } from './model/EventDetailsDTO';
import { EventReportDTO } from './model/event-report.dto';
@Injectable({
  providedIn: 'root',
})
